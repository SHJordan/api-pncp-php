...
/**
 * AlterarUnidadeOrgaoDTO Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class AlterarUnidadeOrgaoDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AlterarUnidadeOrgaoDTO';
    ...
    */
    ...
    public function setCodigoUnidade($codigo_unidade)
    {
        ...
        if ((mb_strlen($codigo_unidade) > 30)) {
            throw new \InvalidArgumentException('invalid length for $codigo_unidade when calling AlterarUnidadeOrgaoDTO., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($codigo_unidade) < 1)) {
            throw new \InvalidArgumentException('invalid length for $codigo_unidade when calling AlterarUnidadeOrgaoDTO., must be bigger than or equal to 1.');
        }
    ...
    public function setNomeUnidade($nome_unidade)
    {
        ...
        if ((mb_strlen($nome_unidade) > 100)) {
            throw new \InvalidArgumentException('invalid length for $nome_unidade when calling AlterarUnidadeOrgaoDTO., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($nome_unidade) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nome_unidade when calling AlterarUnidadeOrgaoDTO., must be bigger than or equal to 1.');
        }
