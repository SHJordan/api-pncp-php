...
/**
 * RecuperarTokenLoginUnicoDTO Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RecuperarTokenLoginUnicoDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RecuperarTokenLoginUnicoDTO';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('adm_pncp', $data ?? [], null);
    }
    ...
    */
     ...
     * @return bool|null
     */
    public function getAdmPncp()
    {
        return $this->container['adm_pncp'];
    }

    /**
     * Sets adm_pncp
     *
     * @param bool|null $adm_pncp adm_pncp
     *
     * @return self
     */
    public function setAdmPncp($adm_pncp)
    {
        if (is_null($adm_pncp)) {
            throw new \InvalidArgumentException('non-nullable adm_pncp cannot be null');
        }
        $this->container['adm_pncp'] = $adm_pncp;
