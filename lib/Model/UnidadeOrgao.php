...
/**
 * UnidadeOrgao Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class UnidadeOrgao implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'UnidadeOrgao';
    ...
    protected static $openAPITypes = [
        'id' => 'int',
        'orgao' => '\OpenAPI\Client\Model\OrgaoEntidade',
    ...
    */
     ...
     * Sets orgao
     *
     * @param \OpenAPI\Client\Model\OrgaoEntidade|null $orgao orgao
     *
     * @return self
     */
    ...
    public function setCodigoUnidade($codigo_unidade)
    {
        ...
        if ((mb_strlen($codigo_unidade) > 30)) {
            throw new \InvalidArgumentException('invalid length for $codigo_unidade when calling UnidadeOrgao., must be smaller than or equal to 30.');
        }
        if ((mb_strlen($codigo_unidade) < 1)) {
            throw new \InvalidArgumentException('invalid length for $codigo_unidade when calling UnidadeOrgao., must be bigger than or equal to 1.');
        }
    ...
    public function setNomeUnidade($nome_unidade)
    {
        ...
        if ((mb_strlen($nome_unidade) > 100)) {
            throw new \InvalidArgumentException('invalid length for $nome_unidade when calling UnidadeOrgao., must be smaller than or equal to 100.');
        }
        if ((mb_strlen($nome_unidade) < 1)) {
            throw new \InvalidArgumentException('invalid length for $nome_unidade when calling UnidadeOrgao., must be bigger than or equal to 1.');
        }
