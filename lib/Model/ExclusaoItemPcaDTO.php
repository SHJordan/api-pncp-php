...
/**
 * ExclusaoItemPcaDTO Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class ExclusaoItemPcaDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExclusaoItemPcaDTO';
    ...
    */
    ...
    public function setJustificativa($justificativa)
    {
        ...
        if ((mb_strlen($justificativa) > 255)) {
            throw new \InvalidArgumentException('invalid length for $justificativa when calling ExclusaoItemPcaDTO., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($justificativa) < 0)) {
            throw new \InvalidArgumentException('invalid length for $justificativa when calling ExclusaoItemPcaDTO., must be bigger than or equal to 0.');
        }
