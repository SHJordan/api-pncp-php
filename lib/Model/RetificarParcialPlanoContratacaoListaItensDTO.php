...
/**
 * RetificarParcialPlanoContratacaoListaItensDTO Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class RetificarParcialPlanoContratacaoListaItensDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'RetificarParcialPlanoContratacaoListaItensDTO';
    ...
    protected static $openAPITypes = [
        'lista' => '\OpenAPI\Client\Model\RetificarParcialPlanoContratacaoItemDTO[]',
    ...
    {
        $this->setIfExists('lista', $data ?? [], null);
    ...
    */
     ...
     * Gets lista
     *
     * @return \OpenAPI\Client\Model\RetificarParcialPlanoContratacaoItemDTO[]|null
     */
     ...
     * Sets lista
     *
     * @param \OpenAPI\Client\Model\RetificarParcialPlanoContratacaoItemDTO[]|null $lista lista
     *
     * @return self
     */
    ...
    {
        if (is_null($lista)) {
            throw new \InvalidArgumentException('non-nullable lista cannot be null');
        }
    ...
    public function setJustificativa($justificativa)
    {
        ...
        if ((mb_strlen($justificativa) > 255)) {
            throw new \InvalidArgumentException('invalid length for $justificativa when calling RetificarParcialPlanoContratacaoListaItensDTO., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($justificativa) < 0)) {
            throw new \InvalidArgumentException('invalid length for $justificativa when calling RetificarParcialPlanoContratacaoListaItensDTO., must be bigger than or equal to 0.');
        }
