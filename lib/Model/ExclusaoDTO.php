 ...
 */
class ExclusaoDTO implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'ExclusaoDTO';
    ...
    */
    ...
    public function setJustificativa($justificativa)
    {
        ...
        if ((mb_strlen($justificativa) > 255)) {
            throw new \InvalidArgumentException('invalid length for $justificativa when calling ExclusaoDTO., must be smaller than or equal to 255.');
        }
        if ((mb_strlen($justificativa) < 0)) {
            throw new \InvalidArgumentException('invalid length for $justificativa when calling ExclusaoDTO., must be bigger than or equal to 0.');
        }
